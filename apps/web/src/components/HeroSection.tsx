        ...
        <div className="relative flex min-h-screen items-center justify-center overflow-hidden h-32 bg-linear-to-r from-blue-600 to-blue-400">
          ...
          <div className="relative z-10 flex max-w-2xl flex-col items-center px-8 text-center">
            ...
            <p className="mb-10 max-w-xl text-pretty text-lg text-black">
              Select a topic and category to view printable worksheets. Build confidence and skills through practice
              with our comprehensive collection of math exercises.
            </p>
            ...
            <div className="mt-16 grid grid-cols-3 gap-6">
              <div className="rounded-2xl border border-brand-purple/20 bg-background/80 p-6 backdrop-blur-sm">
                ...
                <h3 className="mb-2 font-semibold text-foreground">Easy to Use</h3>
                <p className="text-sm text-muted-foreground">Simple navigation and instant access</p>
              </div>
              ...
              <div className="rounded-2xl border border-brand-orange/20 bg-background/80 p-6 backdrop-blur-sm">
                ...
                <h3 className="mb-2 font-semibold text-foreground">Comprehensive</h3>
                <p className="text-sm text-muted-foreground">Wide range of topics covered</p>
              </div>
              ...
              <div className="rounded-2xl border border-brand-purple/20 bg-background/80 p-6 backdrop-blur-sm">
                ...
                <p className="text-sm text-muted-foreground">Download and print anytime</p>
              </div>
            </div>
          </div>
        </div>
